...
par(mfrow=c(1,1))
ggplot(bcoef,aes(x=takers))+geom_density() + geom_vline(xintercept = c(-18.97,42.46),linetype="dashed")
ggplot(bcoef,aes(x=ratio))+geom_density() + geom_vline(xintercept = c(-19.68,0.10),linetype="dashed")
ggplot(bcoef,aes(x=salary))+geom_density() + geom_vline(xintercept = c(-5.24,9.05),linetype="dashed")
ggplot(bcoef,aes(x=expend))+geom_density() + geom_vline(xintercept = c(-3.75,-2.41),linetype="dashed")
